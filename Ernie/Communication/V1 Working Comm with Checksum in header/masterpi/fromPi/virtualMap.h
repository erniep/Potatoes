...
public:
	...
	void set2x2();
	void set3x3();
	void set4x4(); //Change a map into 4x4 settings
...
void virtualMap::set2x2(){
	cout << "Changed to 2x2" << endl;
	totalCells = 4;
	start = &c9;
	curr = &c9;
	fin = &c1;
...
void virtualMap::set3x3(){
	cout << "Changed to 3x3" << endl;
	totalCells = 9;
	start = &c17;
	curr = &c17;
	fin = &c1;
...
void virtualMap::set4x4(){
	cout << "Changed to 4x4" << endl;
	totalCells = 16;
	start = &c25;
	curr = &c25;
	fin = &c1;
