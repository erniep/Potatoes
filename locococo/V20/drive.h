...
#define NUM_SAMPLES					8// Filter window width - Increase if you think data is noisy
...
#define LINEDETECT_K_DEN			1			// Increase if not detecting intersecting lines, decrease vice versa
#define LINEDETECT_K_NUM_2			0			// DONT FUCK WITH
#define LINEDETECT_K_DEN_2			1			// Increase if its not detecting turns, decrease if detecting too many
#define LINEDETECT_K_NUM_3			0			// For Slowing down
#define LINEDETECT_K_DEN_3			1			// Increase if it does slow down enough, and decrease if it is slowing down too early
...
#define NULLS						0
#define BLACKS						1
#define CALIBRATION_NUM_SAMP		800         // Changing this changes our calibration times (how long it calibrates)
