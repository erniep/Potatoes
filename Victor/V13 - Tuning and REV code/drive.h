...
#define NUM_SAMPLES					5//3 is good too

/* Lightsensor PID Reference */
#define LIGHTSENSEREF				100
#define	CALIBRATIONSF				2			// Safety factor for lightsense compare - Tells if on white surface
...
/*	Safety Factor Gains	*/
#define LINEDETECT_K_DEN			20// 12 + 4sf inch squares
#define LINEDETECT_K_NUM			1// 1 inch black line
#define LINEDETECT_K_DEN_2			12//15
#define LINEDETECT_K_NUM_2			1
#define LINEDETECT_K_DEN_3			59//TBD
