...
#define	NULL_READS					350			// Good dont change
...
#define LINEDETECT_K_NUM			10			// For Horizontal checks - dont fuck with
#define LINEDETECT_K_DEN			420			// Increase if not detecting horizontal lines, decrease vice versa
#define LINEDETECT_K_NUM_2			10			// DONT FUCK WITH
#define LINEDETECT_K_DEN_2			480			// Increase if its not detecting intersections, decrease if detecting too many
#define LINEDETECT_K_NUM_3			10			// For Slowing down
#define LINEDETECT_K_DEN_3			900			// Increase if it does slow down enough, and decrease if it is slowing down too early
#define SAMP_PRD					2 //ms		// Sampling frequency, defined in config file
...
#define NULLS						0
#define BLACKS						1
#define CALIBRATION_NUM_SAMP		850         // Changing this changes our calibration times (how long it calibrates)
