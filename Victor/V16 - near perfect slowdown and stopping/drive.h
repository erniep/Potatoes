...
#define NUM_SAMPLES					5//5 is too much - Causes bugs at high speeds
...
#define	NULL_READS					250		// Nulls ignored for this amount of time in ms
#define NULL_READS2					100
// Lower value counts less black lines
#define LINEDETECT_K_NUM			1// 1 inch black line
#define LINEDETECT_K_DEN			325// Essentially checks if a line exists - works because of filter
#define LINEDETECT_K_DEN_2			175//15
#define LINEDETECT_K_NUM_2			1// 1 inch black line
#define LINEDETECT_K_DEN_3			375// Essentially checks if a line exists - works because of filter
#define LINEDETECT_K_NUM_3			1// TBD
#define SAMP_PRD					5 //ms

/* Ramp down/up constants and tunables */
#define DELTA_T_CNST				15000		// The target change in time for the slowdown period as a func of DC
#define TARGET_DC					35			// Ending duty cycle after slowdown
#define FIXPNTCF					1000000		// Fixed point math coffactor
#define RAMPUPCF					3			// A higher number represents a slower rampup speed
...
#define NULLS						0
#define BLACKS						1
#define CALIBRATION_NUM_SAMP		500
